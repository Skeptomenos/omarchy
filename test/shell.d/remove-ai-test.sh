...
grep -qx 'drop:claude-desktop claude-desktop-extra' "$TEST_LOG" ||
  fail "Claude removal includes the exact ARM provider package"
pass "Claude removal includes the exact ARM provider package"
