"""A3 T1 staging GREEN candidate: all 52 RED method bodies remain unchanged.

Run only after independent source/command review in the approved unprivileged
sandbox. This companion changes only the leading docstring and helper SHA.
The accepted three-assertion RED stays frozen. Fixed T1/proof/power expectations
and all 38 historical real-file methods are unchanged. No production constant
is substituted and no operational preflight or live input is used. Private
synthetic-file success is not root staging, hardware or charging acceptance.
...
HELPER_SHA256 = "821d158a495b91462d7da5e338b9d2fb7f26d23ac66762a58d22a28948616e53"
