"""C3 test-first RED: 38 intact D2 tests plus four fixed E-only contracts.
...
This RED copy authenticates the old public helper. It must fail the selected
image/proof assertions, not setup. No production constant is substituted and
no privileged preflight is called. Real synthetic-file operations stay under
/work; they do not certify hardware or root staging. Stdlib/unittest remains
the approved no-install exception. The sealed C2 tree is never mounted.
"""
...
HELPER_SHA256 = "485a68e30c3b94f430e375286756204f7332446c7878393e40ad22bb8a9ebaff"
