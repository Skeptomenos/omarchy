...
| [image](image/) | Bounded newc helper, filesystem guards, fixtures, real-control workload | 58 isolated tests PASS. Exact no-change image/index reconstruction and all 199 binary-only lookups pass. Diagnostic image pending. |
