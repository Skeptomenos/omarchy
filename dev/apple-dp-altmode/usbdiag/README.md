...
Reconciled: 2026-08-28, after approval to continue offline through C2 preparation and review until manual support is needed. [C2 work](../../../docs/plans/dev-147-usb-startup-diagnostic.md#c2-execution-boundary--approved-offline-work-living) is authorized; results are pending. The [C1 result](../../../docs/plans/dev-147-usb-startup-diagnostic.md#c1-result--source-only-correction-living) and [dated evidence](../../../docs/evidence/dev-147-usbdiag-c1-correction-2026-08-28.md) retain source/test PASS, not a module or hardware PASS. The [C0 design](../../../docs/evidence/dev-147-usbdiag-correction-design-2026-08-28.md), [recovery](../../../docs/evidence/dev-147-dp-recovery-2026-08-28.md), and [D3 failure](../../../docs/evidence/dev-147-usbdiag-startup-failure-2026-08-28.md) remain separate. USB acceptance stays HOLD.
...
| [build](build/README.md) | Historical v1 authentication, extraction, build, and control-QA workload sources | Deliberately unchanged; not suitable for v2 preparation. C2 is now approved, but exact new binary/import validation remains pending. |
...
No public install or quick-start command is provided. Tests and builds need a reviewed private continuation with pinned read-only inputs and fresh writable output/temp directories. Do not weaken a guard, create an unrestricted fallback, or rerun a frozen checkpoint's launcher. D2 staging is complete. The [D3 readiness handoff](../../../docs/evidence/dev-147-usbdiag-boot-readiness-2026-08-28.md) and [working-DP recovery handoff](../../../docs/plans/dev-147-m2-displayport.md#current-recovery-handoff--previous-working-dp-image-living) are consumed; do not repeat them. [C2 preparation and review](../../../docs/plans/dev-147-m2-displayport.md#next-step--offline-correction-design-only-living) may now proceed until an exact manual handoff is ready. Stop for monitor connection, sudo, staging, or reboot; do not perform those actions automatically. W/E/B/G is not a boot schedule. No diagnostic reconnect, USB-device test, live swap, mode change, or suspend is authorized. Permitted monitor disconnection is not a confirmed action or test.
