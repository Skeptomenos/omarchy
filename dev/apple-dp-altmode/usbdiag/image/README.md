...
Reconciled: 2026-08-28. The sealed [C2 evidence](../../../../docs/evidence/dev-147-c2-offline-preparation-2026-08-28.md), [C3 helper preparation](../../../../docs/evidence/dev-147-usbearly-staging-helper-2026-08-28.md), [user-run staging PASS](../../../../docs/evidence/dev-147-usbearly-staging-2026-08-28.md), [C4 readiness](../../../../docs/evidence/dev-147-usbearly-boot-readiness-2026-08-28.md), [display loss](../../../../docs/evidence/dev-147-post-c4-display-loss-2026-08-28.md), and [E confirmation](../../../../docs/evidence/dev-147-c4-selection-confirmation-2026-08-28.md) remain separate from the new [functional recovery after intended W](../../../../docs/evidence/dev-147-w-recovery-after-e-2026-08-28.md). Both native outputs returned, but the filename was not restated and shared IDs do not independently prove W artifact startup. Staging, E, and W handoffs are consumed. The [current plan](../../../../docs/plans/dev-147-m2-displayport.md#current-state--display-recovery-observed-living) keeps USB/full Gate 4b HOLD and permits no further device or greeter test. B/G images remain unprepared. See the [staging archive](../staging/README.md); no live-use command or boot permission is supplied here.

Current offline work, 2026-08-28: the [autonomous goal](../../../../docs/plans/dev-147-m2-displayport.md#autonomous-offline-goal--next-test-package-living) and [technical gates](../../../../docs/plans/dev-147-usb-startup-diagnostic.md#autonomous-offline-technical-gates-living) permit one independently justified fresh candidate/diagnostic build, or a substantiated NO-GO dossier. Use fixed pins and fresh verified containment. No old-helper replay, E retry, automatic B/G preparation, or live experiment follows.
...
No helper here stages into `/boot`, loads a module, selects a boot entry, or reboots. C3 staging and all released boot/recovery handoffs are consumed. Do not replay staging, E, or W. There is no new device or greeter test permission. W/E/B/G is not a boot schedule.
