...
Reconciled: 2026-08-28. The sealed [C2 evidence](../../../../docs/evidence/dev-147-c2-offline-preparation-2026-08-28.md) and [C3 helper preparation](../../../../docs/evidence/dev-147-usbearly-staging-helper-2026-08-28.md) remain separate from the later [user-run staging PASS](../../../../docs/evidence/dev-147-usbearly-staging-2026-08-28.md). E is staged but UNBOOTED; the command is consumed. The [current plan](../../../../docs/plans/dev-147-m2-displayport.md#current-handoff--c4-readiness-hold-living) holds C4 for fresh physical/readiness confirmation and a separately reviewed selection/recovery proposal. B/G images remain unprepared. See the [staging archive](../staging/README.md); no new live-use command or boot permission is provided.
...
No helper here stages into `/boot`, loads a module, selects a boot entry, or reboots. The separate C3 staging command is now complete, and the old D2/D3 handoffs remain consumed. Do not replay staging. Any C4 attended selection needs fresh readiness and its separate reviewed selection/recovery handoff; W/E/B/G is not a boot schedule.
