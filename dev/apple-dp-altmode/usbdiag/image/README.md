...
Reconciled: 2026-08-28. The sealed [C2 evidence](../../../../docs/evidence/dev-147-c2-offline-preparation-2026-08-28.md), [C3 helper preparation](../../../../docs/evidence/dev-147-usbearly-staging-helper-2026-08-28.md), and [user-run staging PASS](../../../../docs/evidence/dev-147-usbearly-staging-2026-08-28.md) remain separate from the new [C4 readiness record](../../../../docs/evidence/dev-147-usbearly-boot-readiness-2026-08-28.md). E is staged but UNBOOTED; staging is consumed. The [current plan](../../../../docs/plans/dev-147-m2-displayport.md#current-c4-handoff--one-user-selected-e-boot-living) owns one prepared conditional E case and separate W recovery after final task release and user prerequisites. B/G images remain unprepared. See the [staging archive](../staging/README.md); no live-use command or blanket boot permission is supplied here.
...
No helper here stages into `/boot`, loads a module, selects a boot entry, or reboots. The separate C3 staging command is complete, and the old D2/D3 handoffs remain consumed. Do not replay staging. Only the current conditional C4 handoff can authorize its single case after release and prerequisites; changed readiness requires review. W/E/B/G is not a boot schedule.
