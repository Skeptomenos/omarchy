...
Status: the corrected zero-child structural GREEN and its original pins below are retained history. The current recipe SHA is `1be81904b29c69cb24fae86208c62fb30e830eca46250978a65d8ed19db8de77`, helper SHA is `686d59e63166df1bef1afad27998a6d58f4c28b6b4439b6ccd607b56471268ca`, and structural runner SHA is `31ccbb035e6e92fab6328b203b090c77138d1abdd8f76e1cab430367fb8783b9`. Two production attempts failed closed. The second proved gzip determinism and exposed kmod lookup-line grammar. Current zero-production-child structural run `run-hgr5p8p1` passed 3/3 with 594 unchanged read-only mounts. [Independent QA](../../../../docs/evidence/dev-147-e-lookup-correction-independent-qa-2026-08-30.md) repeated 3/3 in `run-81ol5s2v`; final review passed with no blockers. There is no fresh E-control PASS. Nothing in this structural checkpoint creates a real control result, constructs an image, stages, boots, or changes hardware. See the [second-attempt evidence](../../../../docs/evidence/dev-147-e-operational-second-attempt-lookup-grammar-2026-08-30.md).
