...
Only the executed workload may claim a fresh control. The third operational attempt now does so. T1 assembly, image creation, staging, module load, and hardware testing remain separate and unavailable.
