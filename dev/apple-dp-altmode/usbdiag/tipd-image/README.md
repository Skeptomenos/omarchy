...
Reconciled: 2026-08-30. The [sole private T1 assembly and independent result QA](../../../../docs/evidence/dev-147-t1-private-image-2026-08-30.md) passed. Fresh exact-nine-input probe `run-vpqm7rk3` preceded assembly `run-mvqmtbw_`; both exited 0 without timeout or input change, with 594 read-only mounts. The private image is 19,209,545 bytes, SHA `c72c36736cebba0d6d5b67f47b02330c35d3ef81fed9bf5b3315095b0dd765fe`. Six offline children passed; exactly the TIPD payload changed and all seven indexes stayed identical. Complete result validation and independent candidate/readback audit passed; final-file presence alone is never PASS. The later [user-run staging](../../../../docs/evidence/dev-147-t1-user-staging-2026-08-30.md) passes exact receipt review and independent QA, with destination/preservation checks attributed to David's pinned privileged helper. T1 is staged but UNBOOTED. The package, image, and offline results are unchanged; the live collector is unrun. The staging release is consumed and all boot/capture/cable/recovery holds remain.
