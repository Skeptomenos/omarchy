"""GREEN companion for the separately pinned C2 control-builder metadata gate.

The frozen RED runner and old builder stay unchanged. This companion differs
only in the subject path/pin and this header. It executes the corrected actual
metadata block against the same real retained binaries and preconditions.
It does not compile, build, load, or validate any fresh C2 module.
The approved no-install unittest/typed-stdlib exception remains unchanged.
"""
...
BUILDER = Path("/inputs/builder")
BUILDER_SHA256 = "37376bfdd59efe9a760e3391da591a4114e199f82c1f4557ec6c8e159949506a"
