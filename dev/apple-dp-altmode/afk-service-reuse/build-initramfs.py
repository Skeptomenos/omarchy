...
BASE_SHA256 = "a93dd0c1b3a6c4d81bf76f2f43c7c7a2b8b7e1e0306bc487de018667f9c8c196"
BASE_BYTES = 19184210
EARLY_BYTES = 10240
EARLY_SHA256 = "e7798a1bd4c75ff8b8bdcdf2a0a315f1322a59082f22375d6526094deb3bb4aa"
MAIN_BYTES = 61276160
MAIN_SHA256 = "b906d501a91050a064d0a5e6c9f70fb4ae0ea4ba05b535fffeffa7d61476ca8a"
STOCK_SHA256 = "dbffe74e13a43e15e47fdc5eafe32eb1829b114a3f02f15fe6b18507d622b0e3"
CANDIDATE_SHA256 = "d6332afdf58f4af403201b7a6a469e1202f4370972f85a00054ecd563717d649"
CANDIDATE_BYTES = 8766280
CANDIDATE_BUILD_ID = "1ca52ad1cea00559d5fdfd32177e4d1e694994e1"
...
OUTPUT = Path("/work/initramfs-linux-asahi-m2-displayport-afk-reuse.img")
...
def main() -> None:
  ...
  require(len(matches) == 1 and sha256(matches[0].payload) == STOCK_SHA256, "stock AppleDRM identity mismatch")
  ...
  stock_path = Path("/work/stock-appledrm.ko")
  helper.write_new(stock_path, matches[0].payload)
  for field in ("name", "vermagic", "depends", "alias"):
    require(metadata(candidate_path, field) == metadata(stock_path, field), f"module metadata mismatch: {field}")
  ...
  receipt = {
    ...
    "offline": True,
    "schema": "dev147-afk-reuse-image-v1",
    "staged": False,
    "status": "PASS",
  }
  helper.write_new(
    Path("/work/afk-reuse-image-result.json"),
    (json.dumps(receipt, indent=2, sort_keys=True) + "\n").encode(),
  )
  print("PASS: AppleDRM-only AFK reuse image built offline; nothing staged or loaded")
