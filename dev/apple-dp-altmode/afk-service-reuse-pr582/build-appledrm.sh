...
case $1 in
  control)
    ...
    ;;
  combined)
    source_manifest_sha256=ec67d69cc9551d52c65816520dbde37039f0f6d871fd3fbdaeec9a86d984fb9d
    ;;
  *)
    exit 1
    ;;
...
printf '%s  %s\n' \
  ...
  9b52faf901123ab4f9a0a486c2f7ba5718259dcb0ef68e4aebc9ce3d23a19e2c /inputs/afkpatch \
  dcf1f6c9fa083e47aeb15e284b4e7004cb853902c653e472c3dc73a7eb7eccb1 /inputs/timeoutpatch \
...
/usr/bin/readelf -n appledrm.ko > /work/inspection/elf-notes.txt
...
/usr/bin/find . -maxdepth 1 -type f -name '*.o' -print0 \
  | /usr/bin/sort -z \
  | /usr/bin/xargs -0 /usr/bin/sha256sum > /work/inspection/object-sha256.txt
for symbol in afk_send_command dcp_get_modes dcp_crtc_atomic_check dcp_rtk_crashed iomfb_poweroff_v12_3 iomfb_poweroff_v13_3; do
