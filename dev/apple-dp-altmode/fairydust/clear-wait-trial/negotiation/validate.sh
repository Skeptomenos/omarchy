...
printf 'Negotiation capture software gate: %s\n' "$checks"
...
printf 'PASS: software controls; uname, tracefs and scheduler are explicit test fixtures. No live capture or hardware acceptance.\n' | tee "$checks/result.txt"
