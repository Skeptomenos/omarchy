...
verify_image() {
  local root=$1 build=$2 release=7.1.12-dev147-clearwait100 module relative firmware name dependency parameters dependencies
  local candidate="$build/artifacts/candidate-7.1.12-dev147-clearwait100"
