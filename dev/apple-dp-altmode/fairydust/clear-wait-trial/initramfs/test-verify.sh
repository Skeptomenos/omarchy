...
original="$build_root/artifacts/root/lib/modules/7.1.12-dev147-clearwait100/kernel/drivers/gpu/drm/apple/appledrm.ko"
...
if verify_release_tree "$work" 7.1.12-dev147-clearwait100; then
  printf 'FAIL: empty release tree accepted\n' >&2
  exit 1
fi
mkdir -p "$work/lib/modules/7.1.12-dev147-clearwait100"
verify_release_tree "$work" 7.1.12-dev147-clearwait100
