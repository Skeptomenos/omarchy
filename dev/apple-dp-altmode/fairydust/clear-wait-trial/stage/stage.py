...
BOOT_TARGET = Path(f"/boot/dev147-trial-{RELEASE}")
MODULE_TARGET = Path(f"/usr/lib/modules/{RELEASE}")
STATE_PARENT = Path("/var/lib/dev147-clearwait-stage")
STATE_TARGET = STATE_PARENT / RELEASE
PACKAGE_LOCK = Path("/var/lib/pacman/db.lck")
ACTIVE_PINS = (
  (
    Path("/boot/grub/dev147-paired-7.1.12-dev147-fairydust1/old.cfg"),
    "57d839b9bc7d3488402a8cf7c9e45328dc0097731fc395b0514c467d06b7a327",
  ),
  (
    Path("/boot/grub/dev147-paired-7.1.12-dev147-fairydust1/old.sha256"),
    "b0e5899dfc01b9ddd29a91c5b9ae5dd16f5de9986375470766b30ebf215747a9",
  ),
  (
    Path("/boot/grub/dev147-paired-7.1.12-dev147-fairydust1/candidate.sha256"),
    "4b29319c900ddf4cdfd275c25c31eb7be42be22104b653914f56f6ec90895202",
  ),
  (
    Path("/boot/grub/grub.cfg"),
    "58fd5692f3e28013ce54df8de255c552117c1786a7d027e2da21b7fc8a63a9d2",
  ),
  (
    Path("/boot/grub/dev147-paired-7.1.12-dev147-fairydust1/candidate.cfg"),
    "d4082978c51d96419e98218e472b76653ca52bf1c357fc12ba50786f671efcf6",
  ),
  (
    Path("/boot/efi/m1n1/dev147-recovery/boot.bin.old-203ab702"),
    "203ab7027536c8d16f373d02c1f6346a5c34cfe095a9dafd0cfe37d2b354090c",
  ),
  (
    Path("/boot/dev147-fairydust-7.1.12-dev147-fairydust1/Image"),
    "5175f41bb2d25abce49f6a844cdbe9233a4d090de34fa9aadcf6512c87590079",
  ),
  (
    Path("/boot/dev147-fairydust-7.1.12-dev147-fairydust1/initramfs.img"),
    "e4e70b766e463468f01d1830a4dd1b42b0cbefb4d07463bdf7e54451ecce730a",
  ),
  (
    Path("/boot/dev147-fairydust-7.1.12-dev147-fairydust1/t8112-j413.dtb"),
    "9831d42f9c271ce35dd3e32b5c8298e1c13849568853aea0779f40bb67377b80",
  ),
  (
    Path("/boot/efi/m1n1/boot.bin"),
    "1ae29a2bfadb309562c205520d8c28e2a8df2283bc88bbfb52474e54333c3dff",
  ),
  (
...
BOOT_FILES = ("Image", "initramfs.img", "config")
RECEIPTS = ("kernel-source-config.json", "initramfs.json")
PROTECTED = (
  Path("/boot"),
...
def stage(source: Path, manifest_digest: str) -> None:
  ...
  try:
    ...
    report = {
      ...
      "activation": "not performed; current fairydust default and ESP unchanged; trial requires transient GRUB menu edit",
    }
    write_file(
