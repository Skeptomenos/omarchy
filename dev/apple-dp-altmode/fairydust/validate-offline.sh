...
main() {
  ...
  source_commit=83604c8b18e4673ed91e1172aef9aebeb0af20ce
  config_hash=678853acf4d664a96a4b1a69bba53d3a22ed419d9bf18bb7bcd322956ce849c6
  candidate="$build_root/artifacts/candidate-$release"
  module_root="$build_root/artifacts/root/lib/modules/$release"

  for artifact in Image t8112-j413.dtb config System.map Module.symvers modules.order modules.sha256 kernelrelease.txt source-commit.txt SHA256SUMS; do
