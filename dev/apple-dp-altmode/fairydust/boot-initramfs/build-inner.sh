...
export KERNELVERSION=7.1.12-dev147-fairydust1
set +u
...
mkdir build
mkinitcpio --nopost -n -c /work/mkinitcpio.conf -k /kernel-image -r /candidate -g /work/initramfs-7.1.12-dev147-fairydust1.img -t /work/build
lsinitcpio -l initramfs-7.1.12-dev147-fairydust1.img > inventory.txt
lsinitcpio -c initramfs-7.1.12-dev147-fairydust1.img > embedded-config.txt
mkdir extracted
cd extracted
lsinitcpio -x ../initramfs-7.1.12-dev147-fairydust1.img
