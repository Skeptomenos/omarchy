...
The [main plan](../../../docs/plans/dev-147-m2-displayport.md#pr-582-offline-preparation-living) owns current permission and next steps. The [existing diagnostic export passed review](../../../docs/evidence/dev-147-crashflag-export-2026-08-31.md) and the [paired staging completed](../../../docs/evidence/dev-147-pr582-staged-2026-08-31.md). Staging is separate from the attended boot; preserve the earlier [wrapper preparation](../../../docs/evidence/dev-147-pr582-staging-preparation-2026-08-31.md). This source archive grants no sudo, driver operation, display setting, cable/device change, suspend, reboot, recovery rehearsal or upstream submission. Keep the packaged files, stock/W/T1 images, defaults and old evidence unchanged.
