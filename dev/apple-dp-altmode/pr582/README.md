...
The [main plan](../../../docs/plans/dev-147-m2-displayport.md#pr-582-offline-preparation-living) owns current permission and next steps. Staging, sudo, driver operations, display settings, cable/device changes, suspend, reboot, recovery rehearsal and upstream submission remain held. Preserve the existing volatile diagnostic bundle before any planned reboot. Keep the packaged files, stock/W/T1 images, defaults and old evidence unchanged.
