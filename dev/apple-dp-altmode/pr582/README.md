...
The [main plan](../../../docs/plans/dev-147-m2-displayport.md#pr-582-offline-preparation-living) owns current permission and next steps. The [existing diagnostic export passed review](../../../docs/evidence/dev-147-crashflag-export-2026-08-31.md) and the [paired staging completed](../../../docs/evidence/dev-147-pr582-staged-2026-08-31.md). The [first candidate startup](../../../docs/evidence/dev-147-pr582-candidate-startup-2026-08-31.md) and [later LG 35 failure](../../../docs/evidence/dev-147-pr582-lg35-failure-2026-08-31.md) are separate from [LG 35 recovery on the working drivers](../../../docs/evidence/dev-147-w-recovery-after-pr582-2026-08-31.md). See the later [LG27 observation baseline](../../../docs/evidence/dev-147-lg27-watch-baseline-2026-08-31.md) and [five-entry W/candidate comparison](../../../docs/research/dev-147-w-candidate-comparison-2026-08-31.md). These records do not validate timeout recovery or isolate the responsible change. Preserve the earlier [wrapper preparation](../../../docs/evidence/dev-147-pr582-staging-preparation-2026-08-31.md). This source archive grants no sudo, driver operation, display setting, cable/device change, suspend, reboot, recovery rehearsal or upstream submission. Keep the packaged files, stock/W/T1 images, defaults and old evidence unchanged.
