...
```bash
curl -LO https://raw.githubusercontent.com/Skeptomenos/omarchy-mac/quattro-arm/bin/omarchy-system-boot-to-esp
...
```bash
curl -LO https://raw.githubusercontent.com/Skeptomenos/omarchy-mac/quattro-arm/bin/omarchy-system-btrfs-migrate
