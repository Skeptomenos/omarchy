...
Final text attestation passes for `/home/david/o/.dev147-stage/usb-control-prep-20260831.Cr8fHxv7ec/manual-capture-v2-final.bash`, SHA-256 `10911981237694f669a41b8772b6b4c1a884a0c9120e69785d53cbe1851c1804`. Its only change is the absolute `/usr/bin/sudo` path. The earlier text stays retained but is superseded. The embedded launcher remains byte-identical. Independent syntax, binding, 20 local-link checks and document review pass. A final delivery-only rerun saves the previously missing aggregate stdout/stderr/exit in [delivery-qa-final.Pejj8hLNMx](/home/david/o/.dev147-stage/usb-control-prep-20260831.Cr8fHxv7ec/delivery-qa-final.Pejj8hLNMx): seven PASS groups, exit 0, empty stderr, all three hashes OK. Its manifest SHA-256 is `d545a91ff5124eee623d36a5877ba3707cdbd9b66c2787fc7e70cfd906b304a1`. This closes an evidence-retention gap, not a recorder-code change or another live test.

At the 16:35Z handoff, the coordinator confirms that the final checks pass and releases presentation of the exact manual command. Other tasks hold conflicting machine changes through 16:45 UTC. Startup and arming must occur before 16:41 UTC; the user should start by 16:40 UTC to allow setup. This reservation does not establish that the user ran anything. The manual output directory is still absent in root's 16:35:05Z unprivileged check, and the final literal hash is unchanged. Reservation, manual execution and actual cleanup are separate facts. Time expiry alone does not prove cleanup. A changed boot or expired release requires a newly coordinated binding, not a replay.
