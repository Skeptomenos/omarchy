...
Checkpoint: source tests and control evidence, before actual T1 module/image acceptance. The [living subplan](../plans/dev-147-usb-startup-diagnostic.md#a2-foundation--continued-offline-preparation-living) owns later progress. The [main goal](../plans/dev-147-m2-displayport.md#autonomous-offline-goal--next-test-package-living) still ends before the first manual review/staging boundary.
