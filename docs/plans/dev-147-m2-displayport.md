...
Updated: 2026-08-28, after [post-reboot external-display loss](../evidence/dev-147-post-c4-display-loss-2026-08-28.md). The internal screen works and Linux responds. A new boot is verified, but David's exact selected initramfs filename is unconfirmed; this is not a verified E boot or E failure. The intended E handoff is consumed. Wait for the filename; no retry or W recovery is released. E remains staged, with boot attribution unresolved. [C3 staging](../evidence/dev-147-usbearly-staging-2026-08-28.md) remains complete and consumed, with qualified user-validator provenance. The earlier [W recovery](../evidence/dev-147-dp-recovery-2026-08-28.md) remains one display PASS, not the current result. Full Gate 4b/USB acceptance stays HOLD. D3 remains external-display FAIL / measurement INCONCLUSIVE; its frozen v1 guard is unfixed and video cause unknown. This document owns the current hold and retained procedures. [Linear DEV-147](https://linear.app/helmus/issue/DEV-147/usb-c-displayport-external-monitor-unavailable-on-m2-macbook-air) owns issue status and dated checkpoints.
...
| C4 — intended E case | External image lost after reboot; image selection unconfirmed | New boot verified; internal screen and responsiveness normal. Same loaded IDs cannot distinguish W/E. Wait for the exact filename; no E retry or W recovery released. |
...
### Current handoff — post-reboot selection HOLD (LIVING)
