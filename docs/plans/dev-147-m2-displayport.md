...
Updated: 2026-08-28, after [David confirmed E selection](../evidence/dev-147-c4-selection-confirmation-2026-08-28.md). His confirmation and the saved new-boot capture establish E external-display FAIL; the internal screen works and Linux responds. Shared module IDs alone do not identify E, and the cause remains unknown. The intended E handoff is consumed. One W recovery is prepared below for final task release; it has not been performed. [C3 staging](../evidence/dev-147-usbearly-staging-2026-08-28.md) remains complete and consumed, with qualified user-validator provenance. The earlier [W recovery](../evidence/dev-147-dp-recovery-2026-08-28.md) remains one display PASS, not a guarantee for this attempt. Full Gate 4b/USB acceptance stays HOLD. D3 remains external-display FAIL / measurement INCONCLUSIVE; its frozen v1 guard is unfixed and video cause unknown. No E retry is authorized. [Linear DEV-147](https://linear.app/helmus/issue/DEV-147/usb-c-displayport-external-monitor-unavailable-on-m2-macbook-air) owns issue status and dated checkpoints.
...
| C4 — E case | External-display FAIL; E selection confirmed | User confirmation plus saved boot capture establish the result, not shared IDs alone. Internal screen and responsiveness remain normal. E handoff consumed; no retry. One W recovery is prepared for final release, not performed. |
...
### Current recovery handoff — working image W (LIVING)
