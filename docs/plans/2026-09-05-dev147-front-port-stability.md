...
**Started:** 2026-09-05
**Reconciled:** 2026-09-05 — LG27 initially works, later attachment fails; physical capture sequence under review.
...
- [ ] Slice 2: Prove front-port reconnect endurance.
  ...
  Current dependency: LG27 initially works with 4K video and USB enumeration, then fails after the user unplugged before trace start and reattached during ZU4DfANM. Treat this as attach-only capture: 124/124 records, zero loss, front device role without DP/HPD. Ask whether the cable was inserted once or moved again during capture before interpreting repeated status transitions. Keep cables and kernel fixed; no reboot or another blind reconnect yet. LG35 power-on recovery and unresolved USB difference remain separate comparison evidence.
