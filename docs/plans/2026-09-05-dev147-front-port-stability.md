...
- [ ] Slice 2: Prove front-port reconnect endurance.
  ...
  Current dependency: H6RTWN8n exercises a 53.221 ms clear-swap reply chain and completes the shutdown tail without timeout, supporting the 100 ms diagnostic budget. DRM recovers; visible image confirmation is pending. USB hub repeatedly fails and is absent. Pause further physical cycles for that confirmation and USB isolation; no endurance batch. The saved default remains fairydust1.
