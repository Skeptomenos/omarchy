...
- [ ] Slice 7: keep DisplayPort usable across repeated AFK service generations.
  ...
  - [ ] Capture one bounded physical disconnect and reconnect on the current candidate boot.
  ...
  - One supported monitor completes at least ten controlled reconnect generations. Every generation must regain native video, retain a healthy internal display, and leave Linux responsive with zero service-capacity errors. This gate is blocked because generation 4 failed before AFK service allocation.
  Exit criteria:
